...
sys.path.append("..")
sys.path.append("/home/wwq/XJAIOps/论文代码复现及分析/InterFusion/InterFusion-main")
print(sys.path)
...
from mcmc_recons import mcmc_reconstruct, masked_reconstruct
from cal_IPS import cal_IPS
